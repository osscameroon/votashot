...
/// Selection page for Poll Office (Results) with searchable dropdown.
class SelectPollOfficeResultsPage extends StatefulWidget {
  const SelectPollOfficeResultsPage({super.key});

  @override
  State<SelectPollOfficeResultsPage> createState() =>
      _SelectPollOfficeResultsPageState();
}

class _SelectPollOfficeResultsPageState
    extends State<SelectPollOfficeResultsPage> {
