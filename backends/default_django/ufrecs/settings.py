...
AWS_S3_STS_ENDPOINT_URL = config("AWS_S3_STS_ENDPOINT_URL")
AWS_S3_STS_ROLE_ARN = config("AWS_S3_STS_ROLE_ARN")
...
CSRF_TRUSTED_ORIGINS = ["https://ufrecs.dev.osscameroon.com",]
